...
Airhorn bot uses [DCA](https://github.com/jongsookeum/dca) files, which are
...
with WAV, FLAC, and many other file formats. Of course, you will need to [install](https://github.com/jongsookeum/dca/tree/master/cmd/dca#Getting-Started)
